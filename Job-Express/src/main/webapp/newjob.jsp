			...
			<div class="card">
				<div class="card-body">
					<div class="text-center text-success">
						<i class="fas fa-user-friends mr-0 fa-1x"></i>
					...
					<form action="addjob" method="post">
						<div class="form-group">
							<label>Enter Job Title</label><input type="text" name="title"
						...
						<div class="form-row">
							<div class="form-group col-md-4">
								<label>Location</label> <select name="location"
									...
									<option value="ChhatrapatiShahujiMaharajNagar">
										Chhatrapati Shahuji Maharaj Nagar</option>
									...
									<option value="DadraandNagarHaveli">Dadra and Nagar
										Haveli</option>
									...
									<option value="Kabirdham(formerlyKawardha)">Kabirdham
										(formerly Kawardha)</option>
									...
									<option value="Kendujhar(Keonjhar)">Kendujhar
										(Keonjhar)</option>
									<option value="Khagaria">Khagaria</option>
									<option value="Khammam">Khammam</option>
									<option value="Khandwa(EastNimar)">Khandwa (East
										Nimar)</option>
									<option value="Khargone(WestNimar)">Khargone (West
										Nimar)</option>
									...
									<option value="PanchsheelNagardistrict(Hapur)">
										Panchsheel Nagar district (Hapur)</option>
									...
									<option value="RamabaiNagar(KanpurDehat)">Ramabai
										Nagar (Kanpur Dehat)</option>
									...
									<option value="Subarnapur(Sonepur)">Subarnapur
										(Sonepur)</option>
							...
							<div class="form-group col-md-4">
								<label>Category</label><select class="custom-select"
									...
									<option value="Computer Systems Analyst">Computer
										Systems Analyst</option>
									<option value="Programmers">Database Administrator
										(DBA)</option>
									<option value="System Administrator">System
										Administrator</option>
									<option value="Quality Assurance (QA) Tester">Quality
										Assurance (QA) Tester</option>
									<option value="Search Engine Optimization (SEO) Analyst">Search
										Engine Optimization (SEO) Analyst</option>
									<option value="Administrative Services Manager">Administrative
										Services Manager</option>
									<option value="Construction Manager">Construction
										Manager</option>
									<option value="Direct Supervisors">Direct Supervisors</option>
									<option value="Computer Information Systems Manager">Computer
										Information Systems Manager</option>
									<option value="Food Services Manager">Food Services
										Manager</option>
									<option value="Medical and Health Services Manager">Medical
										and Health Services Manager</option>
									<option value="Sales Manager">Sales Manager</option>
									<option value="Training and Development Manager">Training
										and Development Manager</option>
							...
							<div class="form-group col-md-4">
								<label>Status</label><select class="form-control" name="status">
									<option class="Open" value="Open">Open</option>
						...
						<div class="form-group">
							<label>Enter Eligibility Criteria and Job Description</label>
							<textarea rows="8" cols="" name="desc" class="form-control"></textarea>
						</div>
